    ...
    t.exports = function(n) {
        var a = function(t) {
            ...
            var d = this, u = function(t, n) {
                ...
                var o = e > 0 ? 1 : -1, r = Math.abs(e) / a("#zuck-modal").offsetWidth * 90 * o;
                if (u("cubeEffect")) {
                ...
                t && (c(t.style, "TransitionTimingFunction", i), c(t.style, "TransitionDuration", "".concat(n, "ms")), 
            ...
            var p = function(t) {
                t = 1e3 * Number(t);
                var e = new Date(t), n = e.getTime(), a = (new Date().getTime() - n) / 1e3, i = u("language", "time"), c = [ [ 60, " ".concat(i.seconds), 1 ], [ 120, "1 ".concat(i.minute), "" ], [ 3600, " ".concat(i.minutes), 60 ], [ 7200, "1 ".concat(i.hour), "" ], [ 86400, " ".concat(i.hours), 3600 ], [ 172800, " ".concat(i.yesterday), "" ], [ 604800, " ".concat(i.days), 86400 ] ], r = 1;
                ...
                template: {
                    ...
                    timelineStoryItem: function(t) {
                        var e = [ "id", "seen", "src", "link", "linkText", "time", "type", "length", "preview" ], n = '\n            href="'.concat(i(t, "src"), '"\n            data-link="').concat(i(t, "link"), '"\n            data-linkText="').concat(i(t, "linkText"), '"\n            data-time="').concat(i(t, "time"), '"\n            data-type="').concat(i(t, "type"), '"\n            data-length="').concat(i(t, "length"), '"\n          ');
                ...
                c || d.hasModal || (d.hasModal = !0, (c = document.createElement("div")).id = "zuck-modal", 
                u("cubeEffect") && (c.className = "with-cube"), c.innerHTML = '<div id="zuck-modal-content"></div>', 
                c.style.display = "none", c.setAttribute("tabIndex", "1"), c.onkeyup = function(t) {
                    var e = t.keyCode;
                    27 === e ? h.close() : 13 !== e && 32 !== e || h.next();
                }, u("openEffect") && c.classList.add("with-effects"), u("rtl") && c.classList.add("rtl"), 
                e = function() {
                    c.classList.contains("closed") && (g.innerHTML = "", c.style.display = "none", c.classList.remove("closed"), 
                    c.classList.remove("animated"));
                }, (t = c).transitionEndEvent || (t.transitionEndEvent = !0, r(t, e, "TransitionEnd")), 
                document.body.appendChild(c));
                var g = a("#zuck-modal-content"), b = function(t) {
                    var e = a("#zuck-modal"), n = "", i = "", o = 0, c = a("#zuck-modal-slider-".concat(y)), r = {
                    ...
                    v(c, o, 600, null), setTimeout(function() {
                        if (u("rtl")) {
                            var t = n;
                            n = i, i = t;
                        }
                        if ("" !== n && r[n] && "" !== i) {
                            ...
                            o && o.parentNode.removeChild(o), r.viewing && (r.viewing.classList.add("stopped"), 
                            r.viewing.classList.add(i), r.viewing.classList.remove("viewing")), r[n] && (r[n].classList.remove("stopped"), 
                            r[n].classList.remove(n), r[n].classList.add("viewing"));
                            var l = k(n);
                            l && I(l, n);
                            var m = d.internalData.currentStory, f = a('#zuck-modal [data-story-id="'.concat(m, '"]'));
                            if (f) {
                                var p = (f = f.querySelectorAll("[data-index].active"))[0].firstElementChild;
                                d.data[m].currentItem = parseInt(f[0].getAttribute("data-index"), 10), f[0].innerHTML = '<b style="'.concat(p.style.cssText, '"></b>'), 
                    ...
                    var c = a("#zuck-modal-slider-".concat(y)), r = i(t, "items");
                    ...
                    g.className = "slides", o(r, function(e, n) {
                        n.timeAgo = p(i(n, "time")), b > e && (t.items[e].timeAgo = n.timeAgo, t.items[e].seen = !0, 
                        n.seen = !0), v += u("template", "viewerItemPointer")(e, b, n), m += u("template", "viewerItemBody")(e, b, n);
                    }), g.innerHTML = m;
                    ...
                    S.setAttribute("data-story-id", f), S.querySelector(".slides-pointers .wrap").innerHTML = v, 
                    o(S.querySelectorAll(".close, .back"), function(t, e) {
                        e.onclick = function(t) {
                            t.preventDefault(), h.close();
                        };
                    }), S.appendChild(g), "viewing" === e && x(S, S.querySelectorAll('[data-index="'.concat(b, '"].active')), !1), 
                ...
                return {
                    show: function(t, e) {
                        ...
                        u("callbacks", "onOpen")(t, function() {
                            ...
                            !function(t) {
                                var e = a("#zuck-modal"), i = t, o = {}, c = null, r = null, s = null, l = null, m = null, p = function(t) {
                                    var n = a("#zuck-modal .viewing");
                                    if ("A" !== t.target.nodeName) {
                                        var d = t.touches ? t.touches[0] : t, u = f(a("#zuck-modal .story-viewer.viewing"));
                                        e.slideWidth = a("#zuck-modal .story-viewer").offsetWidth, e.slideHeight = a("#zuck-modal .story-viewer").offsetHeight, 
                                        o = {
                                            x: u[0],
                                            y: u[1]
                                        };
                                        ...
                                        c = {
                                            ...
                                            time: Date.now(),
                                            valid: !0
                                        }, p < 80 || p > e.slideHeight - 80 ? c.valid = !1 : (t.preventDefault(), r = void 0, 
                                        s = {}, i.addEventListener("mousemove", y), i.addEventListener("mouseup", g), i.addEventListener("mouseleave", g), 
                                        i.addEventListener("touchmove", y), i.addEventListener("touchend", g), n && n.classList.add("paused"), 
                                    ...
                                    c && c.valid && (s = {
                                        x: n - c.x,
                                        y: a - c.y
                                    }, void 0 === r && (r = !!(r || Math.abs(s.x) < Math.abs(s.y))), !r && c && (t.preventDefault(), 
                                    v(i, o.x + s.x, 0, null)));
                                }, g = function t(f) {
                                    var p = a("#zuck-modal .viewing"), g = c, h = c ? Date.now() - c.time : void 0, k = Number(h) < 300 && Math.abs(s.x) > 25 || Math.abs(s.x) > e.slideWidth / 3, w = s.x < 0, L = a(w ? "#zuck-modal .story-viewer.next" : "#zuck-modal .story-viewer.previous"), E = w && !L || !w && !L;
                                    if (c && !c.valid) ; else {
                                        s && (r || (k && !E ? b(w) : v(i, o.x, 300)), c = void 0, i.removeEventListener("mousemove", y), 
                                        i.removeEventListener("mouseup", t), i.removeEventListener("mouseleave", t), i.removeEventListener("touchmove", y), 
                                        i.removeEventListener("touchend", t));
                                        var I = d.internalData.currentVideoElement;
                                        if (l && clearInterval(l), p && (x(p, p.querySelectorAll(".active"), !1), p.classList.remove("longPress"), 
                                        p.classList.remove("paused")), m) {
                                            clearInterval(m), m = !1;
                                            var A = function() {
                            ...
                            }(a("#zuck-modal-slider-".concat(y))), d.internalData.currentStory = t, e.currentItem = o, 
                            ...
                            if (u("openEffect")) {
                                ...
                                i.style.marginLeft = "".concat(p[0] + l.offsetWidth / 2, "px"), i.style.marginTop = "".concat(p[1] + l.offsetHeight / 2, "px"), 
                                i.style.display = "block", i.slideWidth = a("#zuck-modal .story-viewer").offsetWidth, 
                                setTimeout(function() {
                                    i.classList.add("animated");
                                }, 10), setTimeout(function() {
                                    s();
                                }, 300);
                            } else i.style.display = "block", i.slideWidth = a("#zuck-modal .story-viewer").offsetWidth, 
                            s();
                    ...
                    next: function(t) {
                        u("callbacks", "onEnd")(d.internalData.currentStory, function() {
                            ...
                            e && (e.classList.add("seen"), d.data[t].seen = !0, d.internalData.seenItems[t] = !0, 
                            E("seenItems", d.internalData.seenItems), w()), a("#zuck-modal .story-viewer.next") ? u("rtl") ? b(!1) : b(!0) : h.close();
                        });
                    },
                    close: function() {
                        var t = a("#zuck-modal");
                        u("callbacks", "onClose")(d.internalData.currentStory, function() {
                            u("backNative") && (n.location.hash = ""), m(t, !0), u("openEffect") ? t.classList.add("closed") : (g.innerHTML = "", 
                ...
                try {
                    d.data[n] || (d.data[n] = {}), d.data[n].id = n, d.data[n].photo = t.getAttribute("data-photo"), 
                    d.data[n].name = t.querySelector(".name").innerText, d.data[n].link = t.querySelector(".item-link").getAttribute("href"), 
                    d.data[n].lastUpdated = t.getAttribute("data-last-updated"), d.data[n].seen = a, 
                ...
                if (o && o.pause(), "video" === a.getAttribute("data-type")) {
                    ...
                    s(), r.addEventListener("loadedmetadata", s), d.internalData.currentVideoElement = r, 
                    r.play(), n && n.target && S(r, t);
                ...
                t.muted = !1, t.volume = 1, t.removeAttribute("muted"), t.play(), t.paused && (t.muted = !0, 
                t.play()), e && e.classList.remove("paused");
            }, E = function(t, e) {
                try {
                    if (u("localStorage")) {
            ...
            d.data = u("stories") || {}, d.internalData = {}, d.internalData.seenItems = I("seenItems") || {}, 
            d.add = d.update = function(e, n) {
                var c, r = i(e, "id"), s = a("#".concat(y, ' [data-id="').concat(r, '"]')), m = i(e, "items"), v = !1;
                if (m[0] && (v = m[0].preview || ""), !0 === d.internalData.seenItems[r] && (e.seen = !0), 
                e.currentPreview = v, s) c = s; else {
                ...
                c.setAttribute("data-id", r), c.setAttribute("data-photo", i(e, "photo")), c.setAttribute("data-last-updated", i(e, "lastUpdated")), 
                b(c), s || u("reactive") || (n ? t.appendChild(c) : l(t, c)), o(m, function(t, e) {
                    d.addItem(r, e, n);
                }), n || w();
            }, d.next = function() {
                h.next();
                ...
                if (!u("reactive")) {
                    ...
                    r.className = i(e, "seen") ? "seen" : "", r.setAttribute("data-id", i(e, "id")), 
                    r.innerHTML = u("template", "timelineStoryItem")(e), n ? s.appendChild(r) : l(s, r);
                }
                !function(t, e) {
                    var n = t.getAttribute("data-id"), a = document.querySelectorAll("#".concat(y, ' [data-id="').concat(n, '"] .items > li')), i = [];
                    if (!u("reactive") || e) {
                        o(a, function(t, e) {
                ...
                var n = d.internalData.currentStory, i = d.data[n].currentItem, c = a('#zuck-modal .story-viewer[data-story-id="'.concat(n, '"]')), r = "previous" === t ? -1 : 1;
                if (!c || 1 === c.touchMove) return !1;
                var s = c.querySelectorAll('[data-index="'.concat(i, '"]')), l = s[0], m = s[1], v = i + r, f = c.querySelectorAll('[data-index="'.concat(v, '"]')), y = f[0], g = f[1];
                if (c && y && g) {
                    var b = u("callbacks", "onNavigateItem");
                    (b = u("callbacks", b ? "onNavigateItem" : "onNextItem"))(n, g.getAttribute("data-story-id"), function() {
                        "previous" === t ? (l.classList.remove("seen"), m.classList.remove("seen")) : (l.classList.add("seen"), 
                        m.classList.add("seen")), l.classList.remove("active"), m.classList.remove("active"), 
                        y.classList.remove("seen"), y.classList.add("active"), g.classList.remove("seen"), 
                        g.classList.add("active"), o(c.querySelectorAll(".time"), function(t, e) {
            ...
            return function() {
                ...
                var a = u("avatars") ? "user-icon" : "story-preview", i = u("list") ? "list" : "carousel", c = u("rtl") ? "rtl" : "";
