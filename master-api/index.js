...
app.put("/approvedCourse/:email", async (req, res) => {
  ...
  try {
    ...
    //   if (referredByUser && referredByUser.myCourses.find(course => course.course_id == mycourses)) {
    //     // ReferredByUser already has the course, but allow referralUser to buy it
    //     console.log("ReferredByUser already has the course");
    //     await user.updateOne(
    //       { $addToSet: { myCourses: { course_id: mycourses, certificate: false, amount_paid: amount_paid } } },
    //     { returnOriginal: false, upsert: true }
    //     );
    //   }
    //   else {
    //     // Attempt to update referralUser's myCourses array
    //     try {
    //       await user.updateOne(
    //         { $addToSet: { myCourses: { course_id: mycourses, certificate: false, amount_paid: amount_paid } } },
    //         { returnOriginal: false, upsert: true }
    //       );
    //       console.log("Course added to myCourses array.");
    //     } catch (error) {
